  ...
  build: {
    "projects":[
      ...
      },
      {
        name:  "scala-xml",
        system: "ivy",
        uri:    "ivy:org.scala-lang.modules#scala-xml_2.11;"${vars.scala-xml.version.number}
      },
      {
        name:  "scala-parser-combinators",
        system: "ivy",
        uri:    "ivy:org.scala-lang.modules#scala-parser-combinators_2.11;"${vars.scala-parser-combinators.version.number}
      },
      {
        name:   "scalacheck",
        system: "ivy",
        uri:    "ivy:org.scalacheck#scalacheck_2.11;"${vars.scalacheck-tag}
      },
      {
        name:   "sbinary",
